    ...
    self.AudioDOMHandler = class AudioDOMHandler extends self.DOMHandler {
        ...
        async _AddEffect(e) {
            ...
            if (type === "filter") effect = new self.C3AudioFilterFX(this, ...params);
                ...
                let buffer = null;
                try {
                    buffer = await this._GetAudioBuffer(e["bufferOriginalUrl"], e["bufferUrl"], e["bufferType"],
                        false)
                } catch (err) {
            ...
            else if (type === "stereopan") effect = new self.C3AudioStereoPanFX(this,
                ...params);
        ...
        _OnMicrophoneStream(localMediaStream,
            tag) {
        ...
        _OnOfflineRenderCompleted(buffer) {
            ...
            for (let i =
                    0, len = buffer["numberOfChannels"]; i < len; ++i) {
